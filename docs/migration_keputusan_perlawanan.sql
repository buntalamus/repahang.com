...
ALTER TABLE `laporan_penilaian`
  ADD COLUMN `skor_ht_home` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor separuh masa pertama - home' AFTER `tahap_kesukaran`,
  ADD COLUMN `skor_ht_away` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor separuh masa pertama - away' AFTER `skor_ht_home`,
  ADD COLUMN `skor_ft_home` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor separuh masa kedua - home' AFTER `skor_ht_away`,
  ADD COLUMN `skor_ft_away` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor separuh masa kedua - away' AFTER `skor_ft_home`,
