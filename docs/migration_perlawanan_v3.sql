...
ALTER TABLE `perlawanan`
  ADD COLUMN IF NOT EXISTS `skor_ht_home` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor separuh masa pertama - home' AFTER `away_team`,
  ...
  ADD COLUMN IF NOT EXISTS `skor_ft_home` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor penuh masa - home' AFTER `skor_ht_away`,
  ADD COLUMN IF NOT EXISTS `skor_ft_away` TINYINT UNSIGNED DEFAULT NULL COMMENT 'Skor penuh masa - away' AFTER `skor_ft_home`,
